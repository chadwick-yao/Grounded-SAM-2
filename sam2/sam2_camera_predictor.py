...
class SAM2CameraPredictor(SAM2Base):
    ...
    def load_first_frame(
        ...
        """Initialize an inference state with the first frame"""
    ...
    def add_new_points_or_box(
        ...
        if box is not None:
            ...
            box_coords = box.reshape(1, 2, 2).to(points.device)
    ...
    def track_camera_stream(
        ...
        if frame_idx in consolidated_frame_inds["cond_frame_outputs"]:
            ...
            storage_key = "non_cond_frame_outputs"
            current_out, pred_masks = self._run_single_inference(
                inference_state=inference_state,
                img=img,
        ...
        # TODO: when using stream, it would result in out of memory error
        self._add_output_per_object(
